<?php include 'menu.php'; ?>
    ...
    <article class="contenido">
        <section class="card">
            ...
            <p>En resolución, él se enfrascó tanto en su lectura, que se le pasaban las noches leyendo de claro en claro, y los días de turbio en turbio, y así, del poco dormir y del mucho leer, se le secó el cerebro, de manera que vino a perder el juicio. Llenósele la fantasía de todo aquello que leía en los libros, así de encantamientos, como de pendencias, batallas, desafíos, heridas, requiebros, amores, tormentas y disparates imposibles, y asentósele de tal modo en la imaginación que era verdad toda aquella máquina de aquellas soñadas invenciones que leía, que para él no había otra historia más cierta en el mundo.[...]</p>
            <br>
            <section id="num-lau">
                <ul class="pagination">
                    <li class="active page-item"><a class="page-link" href="club.php">1</a></li>
                    <li class="page-item"><a class="page-link" href="club2.php">2</a></li>
                    <li class="page-item"><a class="page-link" href="club3.php">3</a></li>
                </ul>
            </section>
            <br>
        </section>
